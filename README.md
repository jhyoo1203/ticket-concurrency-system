# 🚀 우아한테크코스 8기 오픈 미션: 대용량 트래픽 티켓 예매 시스템 (점진적 개선 로드맵 LV.1 ~ LV.5)

> 2주간의 오픈 미션 중 '고난도 문제 해커톤' 유형을 선택하여, '선착순 티켓 예매' 시나리오에서 발생하는 동시성 문제를 정의하고, 이를 LV.1(단순 API)부터 LV.5(메시지 큐)까지 점진적으로 개선하는 과정을 구현했습니다.
